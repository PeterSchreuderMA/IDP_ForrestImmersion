...
public class SceneManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        scenes[sceneCurrent].GetComponent<DissolveAnimation>().SwitchMaterialOfChilderen(0);
    }
    ...
    public IEnumerator SceneTransition()
    {
        ...
        scenes[sceneCurrent].GetComponent<DissolveAnimation>().SwitchMaterialOfChilderen(1);
